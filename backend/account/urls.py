...
from .views import UserListView, CustomUserCreate, MeView, ProfileEditView, ChangePasswordView, DeleteUserView, UserDetail, VerifyUser, ResendActivationCode, PhotoGalleryView, CustomTokenObtainPairView
